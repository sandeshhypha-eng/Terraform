...
output "alb_dns_name" {
  ...
  value       = var.load_balancer_type == "alb" ? try(module.alb[0].alb_dns_name, null) : null
}

output "alb_arn" {
  description = "ARN of the Application Load Balancer"
  value       = var.load_balancer_type == "alb" ? try(module.alb[0].alb_arn, null) : null
}

output "target_group_arn" {
  description = "ARN of the ALB target group"
  value       = var.load_balancer_type == "alb" ? try(module.alb[0].target_group_arn, null) : null
}
